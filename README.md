...
**[Advent\_of\_code](https://github.com/gustyforcast/Advent_of_code)** — Annual AoC puzzle solutions in Python

**dnv-subsea-checks** _(in progress)_ — Python library implementing DNV pipeline design checks: wall thickness (DNV-ST-F101), free-span VIV screening, on-bottom stability (DNV-RP-F109)

## Elsewhere

- [gustyforcast.me](https://gustyforcast.me)
- [StillTime on the App Store](https://apps.apple.com/au/app/stilltime/id6747281882)
